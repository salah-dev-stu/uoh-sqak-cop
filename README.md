...
uv run pytest                                   # 547 tests (545 run + 2 interop-gated), 100% coverage (~6 min)
...
uv run cipherchase replay --log docs/sample-run/log_uoh-sqak-police-729eaa25_g01.json
...
uv run cipherchase verify --log docs/sample-run/log_uoh-sqak-police-729eaa25_g01.json
```
